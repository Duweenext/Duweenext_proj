...
const Login = () => {
    ...
    return (
        <View style={{ flex: 1 }}>
            <Image source={images.background} style={{ height: "100%", position: 'absolute' }} className='h-full absolute' />
            ...
            <View style={style.outerbox}>
                <View style={style.innerbox} >
                    ...
                    {/* input section */}
                    <Animated.View entering={FadeInDown.duration(1000).springify()} style={style.input_section}>
                        <Text style={style.input_header}>Username or Email</Text>
                        <View style={style.input_box}>
                            <TextInput placeholder='example@gmail.com' placeholderTextColor={'#C9C9C9'} style={style.text_input_box} />
                        </View>
                    </Animated.View>
                    <Animated.View entering={FadeInDown.duration(1000).springify()} style={style.input_section}>
                        <Text style={style.input_header}>Password</Text>
                        <View style={style.input_box}>
                            <TextInput placeholder='password' placeholderTextColor={'#C9C9C9'} secureTextEntry={isPasswordVisbile} style={style.text_input_box} />
